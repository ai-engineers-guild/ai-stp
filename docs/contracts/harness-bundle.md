...
| `path_not_portable` | сегмент называет зарезервированное устройство Windows (`CON`, `PRN`, `AUX`, `NUL`, `COM1`–`COM9`, `LPT1`–`LPT9`, с любым расширением), заканчивается точкой или пробелом, либо несёт `:` — разделитель альтернативного потока NTFS |

...
| -------- | ----- | ------- |
| [agent-ux-implementation-plan.md](agent-ux-implementation-plan.md) | Target implementation plan for the agent-first CLI: weakest-model loop, shared task engine, and the website-to-native journeys in epic #261. | 2026-09-18 |
...
| [corporate-core-implementation-plan.md](corporate-core-implementation-plan.md) | Implementation and verification sequence for B2B-01 Corporate core. | 2026-09-12 |
...
| [git-workflow.md](git-workflow.md) | Rules for branches, commits, pull requests, and cross-repository changes. | 2026-09-12 |

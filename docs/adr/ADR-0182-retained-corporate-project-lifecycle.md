...
# ADR-0182: Retained corporate project lifecycle

Status: accepted.

## Context

SPEC-080 requires separate project deprecation, deletion and activity filters.
...
Keep the exact corporate/remote project ID established by ADR-0181. Add one

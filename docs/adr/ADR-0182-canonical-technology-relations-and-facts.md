...
# ADR-0182: Canonical technology relations and attached facts
...
SPEC-081 owns technology/category metadata, aliases, lifecycle, versioned mappings,
reviewed usage facts and projections. SPEC-082 owns the one project–technology pair,

...
Канонический контракт принадлежит `SPEC-046`, архитектурный выбор — `ADR-0089`.

До 2026-08-29 здесь стояли два других идентификатора, и ни один этой темой не
владел: один принадлежит отчётам публикации и доступа CLI, второй — классу
раннеров, на которых исполняются проверки, и в публичном дереве его вовсе нет.
Строка, указывающая читателю, где лежит истина, вела в документы, которые о
профилях не говорят.

...
Каталог запуска первопартийный по `ADR-0034`: гильдия публикует из подтверждённого пространства имён базовые сетапы пяти харнессов и ролевые семейства для Claude Code и Codex. Публикации пользователей дополняют каталог, но холодный старт от них не зависит.

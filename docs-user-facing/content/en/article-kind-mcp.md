...
slug: kind-mcp
locale: en
title: "MCP is an external tool interface, not a secret config"
description: "An expanded guide to MCP: server, client configuration, transport, permissions, and boundary checks."
...
It does not answer "how should the agent use that tool?" ([`skill`](https://ai-stp.aiguild.space/en/docs/components)
or [`instruction`](https://ai-stp.aiguild.space/en/docs/components)), "which package extends the harness?"
([`plugin`](https://ai-stp.aiguild.space/en/docs/components)), or "which named shortcut do I type?"
([`command`](https://ai-stp.aiguild.space/en/docs/components)).
...
on [Security checks](https://ai-stp.aiguild.space/en/docs/components). For MCP, expect at least:
...
See [Setups](https://ai-stp.aiguild.space/en/docs/components).
...
[Components](https://ai-stp.aiguild.space/en/docs/components), [`plugin`](https://ai-stp.aiguild.space/en/docs/components), [`setting`](https://ai-stp.aiguild.space/en/docs/components).

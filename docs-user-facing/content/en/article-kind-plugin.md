...
slug: kind-plugin
locale: en
title: "A plugin is a package that extends the harness"
description: "An expanded guide to plugin: manifest, package contents, harness projections, and installation trust."
...
![Component type: plugin](/content/illustrations/kind-plugin.jpg)
...
([`mcp`](https://ai-stp.aiguild.space/en/docs/components)), "which workflow should the agent follow?"
([`skill`](https://ai-stp.aiguild.space/en/docs/components)), or "which catalog of plugins is this shipped
...
on [Security checks](https://ai-stp.aiguild.space/en/docs/components). For a plugin, expect at
least:
...
- nested members of other kinds, when present, are covered by the
  families on [Security checks](https://ai-stp.aiguild.space/en/docs/components) for those kinds.
...
[Components](https://ai-stp.aiguild.space/en/docs/components), [`mcp`](https://ai-stp.aiguild.space/en/docs/components), [`skill`](https://ai-stp.aiguild.space/en/docs/components).

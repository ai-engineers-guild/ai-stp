...
description: "An expanded guide to agent: specialisation, inputs, tools, limits, and a verifiable result."
...
It does not answer "how should that role do the work?" ([`skill`](https://ai-stp.aiguild.space/en/docs/components)),
"what standing rules apply to everyone?" ([`instruction`](https://ai-stp.aiguild.space/en/docs/components)),
or "which package extends the harness?" ([`plugin`](https://ai-stp.aiguild.space/en/docs/components)).
...
!!! warning "Kind `agent` is not AGENTS.md, and not the CLI Agent Skill"
    ...
    [`ai-stp skill install`](https://ai-stp.aiguild.space/en/docs/components). It is **not** a catalog
    ...
    | `AGENTS.md` | [`instruction`](https://ai-stp.aiguild.space/en/docs/components) | yes |
...
on [Security checks](https://ai-stp.aiguild.space/en/docs/components). For an agent, expect at
least:
...
[`skill`](https://ai-stp.aiguild.space/en/docs/components), [CLI Agent Skill](https://ai-stp.aiguild.space/en/docs/components).

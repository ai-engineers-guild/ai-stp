...
slug: kind-command
locale: en
title: "A command is a named, verifiable operation"
description: "An expanded guide to command: invocation interface, parameters, repeatability, and responsibility boundaries."
published_at: 2026-09-04
tags: [component, command]
draft: false
---

# `command`

![Component type: command](/content/illustrations/kind-command.jpg)
...
([`skill`](https://ai-stp.aiguild.space/en/docs/components)), "what must run automatically on an event?"
([`hook`](https://ai-stp.aiguild.space/en/docs/components)), or "which CLI family does `ai-stp` itself expose?"
(those pages live under [`cli/`](https://ai-stp.aiguild.space/en/docs/components)).
...
!!! warning "Kind `command` is not the `ai-stp` CLI"
    ...
    documented under [CLI](https://ai-stp.aiguild.space/en/docs/components). They are not catalog
    ...
    | `ai-stp …` CLI groups | [CLI map](https://ai-stp.aiguild.space/en/docs/components) | no |
...
on [Security checks](https://ai-stp.aiguild.space/en/docs/components). For a command, expect at
least:
...
**Not this kind** — `ai-stp` CLI groups (see [CLI](https://ai-stp.aiguild.space/en/docs/components)):
...
2. Give it a short name, a description a person can read, and bounded
   arguments. Put a procedure with assets in a [`skill`](https://ai-stp.aiguild.space/en/docs/components)
   instead.
...
[Components](https://ai-stp.aiguild.space/en/docs/components), [`skill`](https://ai-stp.aiguild.space/en/docs/components), [`hook`](https://ai-stp.aiguild.space/en/docs/components),
[CLI map](https://ai-stp.aiguild.space/en/docs/components).

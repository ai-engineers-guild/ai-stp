...
locale: ru
title: "Постоянные правила — это отдельный компонент, а не роль агента"
description: "Расширенный разбор instruction: границы, приоритеты, нативные файлы и безопасное распространение."
...
([`skill`](https://ai-stp.aiguild.space/ru/docs/components)), «какой именованный shortcut набрать?»
([`command`](https://ai-stp.aiguild.space/ru/docs/components)) и «какая специализированная роль должна
выполнять работу?» ([`agent`](https://ai-stp.aiguild.space/ru/docs/components)).
...
!!! warning "AGENTS.md — это instruction, а не `agent`"
    ...
    `instruction` (или [`setting`](https://ai-stp.aiguild.space/ru/docs/components)). Вида `memory` нет.
...
спецификации есть только у [`skill`](https://ai-stp.aiguild.space/ru/docs/components).
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для instruction ожидайте
как минимум:
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [`agent`](https://ai-stp.aiguild.space/ru/docs/components), [`skill`](https://ai-stp.aiguild.space/ru/docs/components).

...
slug: kind-hook
locale: ru
title: "Hook — автоматическое действие на событие жизненного цикла"
description: "Расширенный разбор hook: события, argv, детерминированность, побочные эффекты и откат."
...
![Component type: hook](/content/illustrations/kind-hook.jpg)
...
([`command`](https://ai-stp.aiguild.space/ru/docs/components)), «как агент должен делать этот класс задач?»
([`skill`](https://ai-stp.aiguild.space/ru/docs/components)) и «какое постоянное правило агент должен помнить?»
([`instruction`](https://ai-stp.aiguild.space/ru/docs/components)).
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для hook ожидайте как
минимум:
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [`command`](https://ai-stp.aiguild.space/ru/docs/components), [`plugin`](https://ai-stp.aiguild.space/ru/docs/components).

...
description: "Расширенный разбор skill: триггер, процедура, progressive disclosure и поверхность цепочки поставок."
...
!!! warning "Два разных объекта с именем skill"
    ...
    [`ai-stp skill install`](https://ai-stp.aiguild.space/ru/docs/components), проверяется через
...
- Сканеры безопасности, которые используются при публикации, если
  ...
  [Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components).
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для skill ожидайте как
минимум:
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [CLI Agent Skill](https://ai-stp.aiguild.space/ru/docs/components).

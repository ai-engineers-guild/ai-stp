...
slug: kind-setting
locale: ru
title: "Setting — несекретные параметры поведения"
description: "Расширенный разбор setting: конфигурационный файл, область действия, MCP-имена и запрет на секреты."
...
([`instruction`](https://ai-stp.aiguild.space/ru/docs/components)), «что должно выполниться на событии?»
([`hook`](https://ai-stp.aiguild.space/ru/docs/components)) и «какие MCP-серверы объявлены в этом же файле?»
(эта находка — вид [`mcp`](https://ai-stp.aiguild.space/ru/docs/components), `native_role`
`mcp_client_config`).
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для setting ожидайте как
минимум:
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [`mcp`](https://ai-stp.aiguild.space/ru/docs/components), [`instruction`](https://ai-stp.aiguild.space/ru/docs/components).

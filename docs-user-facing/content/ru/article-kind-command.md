...
slug: kind-command
locale: ru
title: "Command — проверяемая операция с именем"
description: "Расширенный разбор command: интерфейс запуска, параметры, повторяемость и границы ответственности."
...
([`skill`](https://ai-stp.aiguild.space/ru/docs/components)), «что должно выполниться автоматически на событии?»
([`hook`](https://ai-stp.aiguild.space/ru/docs/components)) и «какое семейство CLI открывает сам `ai-stp`?»
(эти страницы живут в [`cli/`](https://ai-stp.aiguild.space/ru/docs/components)).
...
!!! warning "Вид `command` — не CLI `ai-stp`"
    ...
    описаны в [CLI](https://ai-stp.aiguild.space/ru/docs/components). Это не компоненты каталога, их не
    ...
    | Группы CLI `ai-stp …` | [Карта CLI](https://ai-stp.aiguild.space/ru/docs/components) | нет |
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для command ожидайте как
минимум:
...
**Не этот вид** — группы CLI `ai-stp` (см. [CLI](https://ai-stp.aiguild.space/ru/docs/components)):
...
2. Дайте короткое имя, описание, которое прочитает человек, и
   ...
   [`skill`](https://ai-stp.aiguild.space/ru/docs/components).
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [`skill`](https://ai-stp.aiguild.space/ru/docs/components), [`hook`](https://ai-stp.aiguild.space/ru/docs/components),
[Карта CLI](https://ai-stp.aiguild.space/ru/docs/components).

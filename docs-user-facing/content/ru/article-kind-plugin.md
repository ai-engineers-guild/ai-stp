...
slug: kind-plugin
locale: ru
title: "Plugin — пакет, который расширяет сам харнесс"
description: "Расширенный разбор plugin: манифест, состав пакета, проекции по harness и доверие к установке."
...
Он не отвечает «какой один MCP-сервер подключён?» ([`mcp`](https://ai-stp.aiguild.space/ru/docs/components)),
«какой workflow должен следовать агент?» ([`skill`](https://ai-stp.aiguild.space/ru/docs/components)) и «через
...
[Проверки безопасности](https://ai-stp.aiguild.space/ru/docs/components). Для plugin ожидайте как
минимум:
...
[Компоненты](https://ai-stp.aiguild.space/ru/docs/components), [`mcp`](https://ai-stp.aiguild.space/ru/docs/components), [`skill`](https://ai-stp.aiguild.space/ru/docs/components).

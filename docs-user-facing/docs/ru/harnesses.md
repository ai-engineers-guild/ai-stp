...
| --- | --- | --- | --- |
| Claude Code | beta | паспорта, совместимость, сборка сетапа, provider-план | входит в открытую бету вместе с остальными шестью |
| Codex | beta | паспорта, совместимость, сборка сетапа, provider-план | входит в открытую бету вместе с остальными шестью |
| Grok Build | beta | паспорта, совместимость, сборка сетапа, provider-план | входит в открытую бету вместе с остальными шестью |
| Pi | beta | паспорта, совместимость, сборка сетапа, provider-план | входит в открытую бету вместе с остальными шестью |
| OpenCode | beta | паспорта, совместимость, сборка сетапа, provider-план | входит в открытую бету вместе с остальными шестью |
| Cursor | beta | паспорта, совместимость, сборка сетапа, provider-план | plugin pack распознаётся по манифесту `.cursor-plugin` |
| Antigravity | beta | паспорта, совместимость, сборка сетапа, provider-план | конфигурация лежит внутри `~/.gemini`, а не в собственном каталоге |
...
=== "Открытая бета: все семь харнессов"

    Claude Code, Codex, Grok Build, Pi, OpenCode, Cursor и Antigravity
    выпускаются вместе. Найти сетап, проверить совместимость, увидеть план и
    применить через provider. Отсутствующее доказательство помечается
    `not_verified`; харнесс из продукта не вычёркивается.
...
## Что оказывается на диске у семи харнессов
...
- [Понятия](concepts/index.md) — что такое харнесс, в отличие от сетапа.
- [Быстрый старт для человека](quickstart/human.md) — первый запуск, когда
  программы нет.
- [Программа harness](cli/harness.md) — поставить бинарник, не сетап.
- [Provider](cli/provider.md) — единственный писатель нативного состояния.
- [Компоненты](components/index.md) — какие виды принимает каждый харнесс.
- [Сетапы](setups/index.md) — сетап принадлежит одному харнессу с создания.
- [Диагностика](troubleshooting/index.md) — `undefined` не ставится сам.

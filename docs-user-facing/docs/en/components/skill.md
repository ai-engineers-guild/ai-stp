---
title: "skill"
description: "Skill components: repeatable workflows for an agent, distinct from the CLI Agent Skill."
---
...
!!! warning "Two different objects named skill"
    ...
    [`ai-stp skill install`](../cli/skill.md), inspected with
...
[Security checks](../security-checks.md). For a skill, expect at least:
...
[Components](index.md), [CLI Agent Skill](../cli/skill.md).

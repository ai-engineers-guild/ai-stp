"""Frozen Sprint-1 catalog fixtures (SPEC-021 REQ-2110).
...
from ai_stp_platform.catalog_seed import SeedResult
...
async def load_fixture_seed(
    session: AsyncSession,
    *,
    store: ImmutableObjectStore | None = None,
) -> SeedResult:
    """Explicitly load frozen contract fixtures into a test transaction."""
    created_accounts = 0

...
Отдельное решение пользователя требуется, когда появляется то, чего в задаче не
было:

- невыбранный вариант, который меняет результат;
- публикация, изменение публичности или права доступа;
- создание основной линии версии;
...
- Git push, PR, merge или deployment, которых задача не требовала.

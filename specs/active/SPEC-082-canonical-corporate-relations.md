---
description: "SPEC-082: Single canonical team/project/technology relationships, responsibility, and current assignment scopes."
last_verified: "2026-09-12"
---

# SPEC-082: Canonical corporate relations

## Purpose

Implement #209 as the sole owner of corporate team/project/technology relations.
SPEC-081 supplies technology metadata and facts, not competing relationship rows.
...
- `REQ-8101`: The canonical project–technology link has immutable identity and
  ...
  versions and evidence attach to this link through SPEC-081 usage facts.
  ...
  Canonical link identities use the registered `relation` prefix (ADR-0182).
...
- `REQ-8104`: Explicit `subject` and `applicability` references from catalog setups
  ...
  facts contribute to SPEC-081 usage counts.
...
under SPEC-079. Technology lifecycle and usage review remain SPEC-081 dimensions.
...
deleted projects under ADR-0183; legacy state is only a compatibility projection.

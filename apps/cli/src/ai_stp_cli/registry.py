...
DECLARATIONS: Final[tuple[Declaration, ...]] = (
    ...
    Declaration(
        ...
        summary="Read the immutable status of one local component evaluation run.",
        result_schema="urn:ai-stp:schema:v1:cli-component-eval-result",
    ...
    Declaration(
        ...
        summary="Show full immutable local evidence for one component evaluation run.",
        result_schema="urn:ai-stp:schema:v1:cli-component-eval-result",
        handler="evaluation:component_show",
        parameters=(option("run-id", "string", "Evaluation run identifier.", required=True),),
    ),
    Declaration(
        path=["eval", "status"],
        summary="Read the immutable status of one local setup evaluation run.",
        result_schema="urn:ai-stp:schema:v1:cli-setup-eval-result",
    ...
    Declaration(
        path=["eval", "show"],
        summary="Show full immutable local evidence for one setup evaluation run.",
        result_schema="urn:ai-stp:schema:v1:cli-setup-eval-result",
    ...
    Declaration(
        ...
        mutability="plan",
        parameters=(
            option("id", "string", "Stable identifier of the source component.", required=True),
            option(
                "to-harness",
                "string",
            ...
            option(
                "from-harness",
                "string",
                "Source adaptation when the version names more than one.",
                choices=HARNESS_ID_ORDER,
            ),
    ...
    Declaration(
        ...
        summary="Record the exact still-current target-harness adaptation.",
        result_schema="urn:ai-stp:schema:v1:cli-component-materialize-result",
        handler="component_materialize:apply",
        mutability="apply",
        confirmation="plan_digest",
        parameters=(
            option("id", "string", "Stable identifier of the source component.", required=True),
            ...
            option("overlay-id", "string", "Exact overlay id returned by plan.", required=True),
            option(
                "local-only",
                "boolean",
                "Fork a private overlay instead of minting the next owner version.",
    ...
    Declaration(
        ...
        summary="Preview a claimed-portable local overlay for a missing target adaptation.",
        result_schema="urn:ai-stp:schema:v1:cli-component-materialize-plan",
        handler="component_materialize:portability_plan",
        mutability="plan",
        parameters=(
            option("id", "string", "Stable identifier of the source component.", required=True),
            option(
    ...
    Declaration(
        ...
        summary="Record a private local overlay from an explicit portability claim.",
        result_schema="urn:ai-stp:schema:v1:cli-component-materialize-result",
        handler="component_materialize:portability_apply",
        mutability="apply",
        confirmation="plan_digest",
        parameters=(
            option("id", "string", "Stable identifier of the source component.", required=True),
    ...
    Declaration(
        ...
        summary="Install one catalog cli component as a shared executable.",
        result_schema="urn:ai-stp:schema:v1:cli-component-program",
        handler="cli_program:install",
        mutability="apply",
        parameters=(
    ...
    Declaration(
        ...
        summary="Run the shared cli executable by exact installed path.",
        result_schema="urn:ai-stp:schema:v1:cli-component-program",
        handler="cli_program:invoke",
        mutability="apply",
        parameters=(
            option("id", "string", "Stable identifier of the cli component.", required=True),
            option("version", "string", "Exact X.Y version. Omitted, the newest recorded."),
    ...
    Declaration(
        ...
        summary="Report whether the shared cli executable is present.",
        result_schema="urn:ai-stp:schema:v1:cli-component-program",
    ...
    Declaration(
        ...
        summary="Remove the shared cli executable this installation created.",
        result_schema="urn:ai-stp:schema:v1:cli-component-program",
        handler="cli_program:remove",
        mutability="destructive",
        confirmation="explicit_flag",
        parameters=(
            option("id", "string", "Stable identifier of the cli component.", required=True),
    ...
    Declaration(
        ...
        result_schema="urn:ai-stp:schema:v1:project-link-plan-response",
        handler="project:link_plan",
        mutability="plan",
        parameters=(
            ...
            option(
                "remote-project-id", "string", "Stable remote project identifier.", required=True
            ),
            option("provider-project-id", "string", "Optional provider project identifier."),
            option("local-revision", "string", "Observed local revision.", required=True),
            option("remote-revision", "string", "Observed remote revision.", required=True),
            option("provider-revision", "string", "Observed provider revision."),
            option(
                "authorization-revision",
                "string",
    ...
    Declaration(
        ...
        summary="Read one authoritative project link plan.",
        result_schema="urn:ai-stp:schema:v1:project-link-plan-response",
        handler="project:link_plan_show",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
    ...
    Declaration(
        ...
        summary="Confirm one exact server-authored project link plan.",
        result_schema="urn:ai-stp:schema:v1:project-link-response",
        handler="project:link",
        mutability="apply",
        confirmation="explicit_flag",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
            option("plan-id", "string", "Exact project link plan identifier.", required=True),
            option(
                "plan-digest", "string", "Exact digest returned by the link plan.", required=True
            ),
            option(
                "authorization-revision",
                "string",
            ...
            option(
                "idempotency-key",
                "string",
                "Stable key for this exact confirmation.",
                required=True,
            ),
    ...
    Declaration(
        ...
        summary="Read one authoritative project link.",
        result_schema="urn:ai-stp:schema:v1:project-link-response",
        handler="project:link_show",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
    ...
    Declaration(
        ...
        result_schema="urn:ai-stp:schema:v1:project-unlink-plan-response",
        handler="project:unlink_plan",
        mutability="plan",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
            option("link-id", "string", "Explicit project link identifier.", required=True),
    ...
    Declaration(
        ...
        summary="Read one authoritative project unlink plan.",
        result_schema="urn:ai-stp:schema:v1:project-unlink-plan-response",
        handler="project:unlink_plan_show",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
    ...
    Declaration(
        path=["project", "unlink"],
        summary="Confirm one exact server-authored project unlink plan.",
        result_schema="urn:ai-stp:schema:v1:project-link-response",
        handler="project:unlink",
        mutability="destructive",
        confirmation="explicit_flag",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
            ...
            option(
                "plan-digest",
                "string",
                "Exact digest returned by the unlink plan.",
                required=True,
            ),
            option(
                "authorization-revision",
    ...
    Declaration(
        ...
        summary="Create a deterministic no-side-effect project sync plan.",
        result_schema="urn:ai-stp:schema:v1:project-sync-plan-response",
        handler="project:sync_plan",
        mutability="plan",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
            option("link-id", "string", "Explicit project link identifier.", required=True),
    ...
    Declaration(
        ...
        result_schema="urn:ai-stp:schema:v1:project-sync-plan-response",
        handler="project:sync_apply",
        mutability="apply",
        confirmation="plan_digest",
        parameters=(
            option("organization-id", "string", "Explicit remote organization.", required=True),
            option("link-id", "string", "Explicit project link identifier.", required=True),
            option("plan-id", "string", "Exact sync plan identifier.", required=True),
            option("local-project-id", "string", "Stable local project identifier.", required=True),
            option("plan-digest", "string", "Exact digest returned by sync plan.", required=True),
            option(
                "expected-link-revision",
                "integer",
                "Expected current link revision.",
    ...
    Declaration(
        path=["heartbeat", "send"],
        summary="Write this installation's heartbeat for one organization.",
        result_schema="urn:ai-stp:schema:v1:installation-heartbeat",
        handler="heartbeat:send",
        mutability="apply",
        parameters=(
            option(
                "organization",
                "string",
                "Organization the installation reports to.",
                required=True,
            ),
            option(
                "state",
    ...
    Declaration(
        ...
        parameters=(
            option(
                "organization",
                "string",
                "Organization to read health from.",
                required=True,
            ),
        ),
        next_actions=("help --path heartbeat --json",),
    ...
    Declaration(
        path=["heartbeat", "installations"],
        summary="Installation health visible to the caller's role.",
        result_schema="urn:ai-stp:schema:v1:installation-heartbeat-list",
        handler="heartbeat:installations",
        parameters=(
            option(
                "organization",
                "string",
                "Organization whose installations to list.",
                required=True,
            ),
            option(
                "health",
    ...
    Declaration(
        ...
        parameters=(
            ...
            option("component-digest", "string", "Component passport digest.", required=True),
            option("invoked-at", "string", "RFC 3339 invocation timestamp.", required=True),
            option(
                "outcome",
                "string",
                "Invocation outcome.",
    ...
    Declaration(
        path=["usage", "report"],
        summary="Scoped aggregate report: frequency, first/last, installed state.",
        result_schema="urn:ai-stp:schema:v1:runtime-usage-report",
        handler="usage:report",
        parameters=(
            option("organization", "string", "Organization to report on.", required=True),
            option("employee", "string", "Filter by employee account."),
            option("team", "string", "Filter by team."),
            option("device", "string", "Filter by device."),
            option("project", "string", "Filter by project."),
            option("technology", "string", "Filter by technology."),
            option("harness", "string", "Filter by harness."),
            ...
            option("from", "string", "RFC 3339 lower bound on invocation time."),
            option("to", "string", "RFC 3339 upper bound on invocation time."),
            option("group-by", "string", "Grouping axis.", choices=("component", "setup")),
            option("offset", "integer", "Rows to skip."),
            option("limit", "integer", "Rows to return."),
        ),
        next_actions=("help --path usage --json",),
    ),
    Declaration(
        path=["usage", "events"],
        summary="The separately permissioned, redacted event-level drill-down.",
        result_schema="urn:ai-stp:schema:v1:runtime-usage-event-list",
        handler="usage:events",
        parameters=(
            option("organization", "string", "Organization to read events from.", required=True),
            option("employee", "string", "Filter by employee account."),
            option("team", "string", "Filter by team."),
            option("device", "string", "Filter by device."),
            option("project", "string", "Filter by project."),
    ...
    Declaration(
        path=["usage", "export"],
        summary="Create a bounded, digested export receipt. Audited.",
        result_schema="urn:ai-stp:schema:v1:runtime-usage-export-view",
        handler="usage:export",
        mutability="apply",
        confirmation="explicit_flag",
        parameters=(
            option("organization", "string", "Organization to export from.", required=True),
            option(
                "authorization-revision",
                "integer",
                "Policy revision the export is authorized under.",
                required=True,
            ),
            option("idempotency-key", "string", "Export idempotency key.", required=True),
            option("confirm", "boolean", "Required; the export is audited.", required=True),
            option("employee", "string", "Filter by employee account."),
            option("team", "string", "Filter by team."),
            option("device", "string", "Filter by device."),
            option("project", "string", "Filter by project."),
    ...
    Declaration(
        path=["usage", "flush"],
        summary="Drain due buffered events over the authenticated corporate channel.",
        result_schema="urn:ai-stp:schema:v1:runtime-usage-flush-result",
        handler="usage:flush",
        mutability="apply",
        parameters=(
    ...
    Declaration(
        path=["task", "intents"],
        summary="List shipped task intents and when to start each one.",
        result_schema="urn:ai-stp:schema:v1:cli-task-intents",
        handler="task:intents",

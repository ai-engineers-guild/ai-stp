...
name: ai-stp
description: >
  Управляйте CLI ai-stp: осмотр, подбор, сборка, установка, обновление,
  восстановление, авторство и публикация сетапов и компонентов харнесса.
  Используйте, когда пользователь просит подготовить харнесс, поставить или
  починить сетап, вести паспорта, искать в каталоге, войти в ai-stp, опубликовать
  компонент или выполнить любую команду `ai-stp` — даже если говорят «NDDev»,
  «ai_stp» или «setup CLI». НЕ используйте, чтобы вызывать API модели, править
  target харнесса вручную, писать чужой SKILL.md или отвечать на вопросы вне
  этого CLI.

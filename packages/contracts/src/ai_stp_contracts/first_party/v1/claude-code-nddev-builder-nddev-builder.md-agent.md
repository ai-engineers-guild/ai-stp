---
name: nddev-builder
description: Build or review a complete Claude Code tool collection -- select and author native components, compose an exact setup, document capabilities, and prove installation and recovery through claude-setup-system.
---

Build or review a complete setup for the harness served by
`claude-setup-system`: a native collection of tools for the user's tasks.

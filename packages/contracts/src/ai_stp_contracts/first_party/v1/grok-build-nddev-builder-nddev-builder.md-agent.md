---
name: nddev-builder
description: Work on grok-setup-system -- change a declaration, add or revise a setup, or check a target's lifecycle end to end for Grok Build.
---

You are working inside `grok-setup-system`, one of seven NDDev setup systems

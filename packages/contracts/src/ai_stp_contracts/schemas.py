...
HTTP_MODELS: Final[dict[str, ExportedSchema]] = {
    ...
    "technology-mutation": TechnologyMutation,
    ...
    "technology-seed-result": TechnologySeedResult,
    "project-team-list": ProjectTeamList,
    "project-technology-list": ProjectTechnologyList,
    "technology-team-list": TechnologyTeamList,
    "relationship-list-query": RelationshipListQuery,
    "project-team-view": ProjectTeamView,
    "project-team-write-request": ProjectTeamWriteRequest,
    "technology-team-view": TechnologyTeamView,
    "technology-team-write-request": TechnologyTeamWriteRequest,
    "technology-decision-view": TechnologyDecisionView,
    "technology-decision-request": TechnologyDecisionRequest,
    "technology-category-list": CategoryList,
    "technology-category-view": CategoryView,
    "technology-category-lifecycle-request": CategoryLifecycleRequest,
    "technology-category-write-request": CategoryWriteRequest,
    "technology-view": TechnologyView,
    "technology-list": TechnologyList,
    "technology-merge-plan-view": TechnologyMergePlanView,
    "technology-merge-plan-query": TechnologyMergePlanQuery,
    "technology-merge-request": TechnologyMergeRequest,
    "technology-merge-result": TechnologyMergeResult,
    "technology-list-query": TechnologyListQuery,
    "technology-landscape-query": TechnologyLandscapeQuery,
    "technology-landscape-view": TechnologyLandscapeView,
    "technology-landscape-policy-request": TechnologyLandscapePolicyRequest,
    "technology-landscape-policy-view": TechnologyLandscapePolicyView,
    "project-activity-request": ProjectActivityRequest,
    "project-activity-view": ProjectActivityView,
    "technology-write-request": TechnologyWriteRequest,
    "technology-lifecycle-request": TechnologyLifecycleRequest,
    "project-technology-view": ProjectTechnologyView,
    "project-technology-write-request": ProjectTechnologyWriteRequest,
    ...
    "capability-scope-query": CapabilityScopeQuery,
    ...
    "corporate-job-title-create-request": CorporateJobTitleCreateRequest,
    "corporate-job-title-list": CorporateJobTitleList,
    "corporate-job-title-update-request": CorporateJobTitleUpdateRequest,
    "corporate-job-title": CorporateJobTitleView,
    "corporate-catalog-assignment": CorporateCatalogAssignment,
    "corporate-catalog-assignment-list": CorporateCatalogAssignmentList,
    "corporate-catalog-assignment-request": CorporateCatalogAssignmentRequest,
    "corporate-catalog-assignment-query": CorporateCatalogAssignmentQuery,
    "corporate-catalog-usage": CorporateCatalogUsage,
    "corporate-catalog-usage-list": CorporateCatalogUsageList,
    "corporate-catalog-usage-query": CorporateCatalogUsageQuery,
    "corporate-effective-assignment": CorporateEffectiveAssignment,
    "corporate-effective-assignment-query": CorporateEffectiveAssignmentQuery,
    "corporate-distribution-request": CorporateDistributionRequest,
    ...
    "corporate-member-profile-request": CorporateMemberProfileRequest,
    ...
    "corporate-project-lifecycle-request": CorporateProjectLifecycleRequest,
    ...
    "owner-object-capabilities": OwnerObjectCapabilities,
...
CLI_MODELS: Final[dict[str, ExportedSchema]] = {
    ...
    "cli-technology-scan": CliTechnologyScan,
    ...
    "cli-managed-verification": ManagedVerification,
    "cli-rollback-target": RollbackTarget,
    "cli-target-backups": TargetBackups,
    "cli-task": TaskView,
    "cli-task-input-inspect": TaskInspectInput,
    "cli-task-input-initialize": TaskInitializeInput,
    "cli-task-input-install": TaskInstallInput,
    "cli-task-input-change": TaskChangeInput,
    "cli-task-input-author": TaskAuthorInput,
    ...
    "cli-schema-document": CliSchemaDocument,

...
HTTP_MODELS: Final[dict[str, ExportedSchema]] = {
    ...
    "organization-list": OrganizationListResponse,
    "organization-summary": OrganizationSummary,
    "capability-projection": CapabilityProjection,
    "active-context": ActiveContext,
    "corporate-audit-entry": CorporateAuditEntry,
    "corporate-audit-export": CorporateAuditExport,
    "corporate-audit-list": CorporateAuditList,
    "corporate-audit-query": CorporateAuditQuery,
    "corporate-binding": CorporateBinding,
    "corporate-binding-list": CorporateBindingList,
    "corporate-binding-request": CorporateBindingRequest,
    ...
    "corporate-member-create-request": CorporateMemberCreateRequest,
    "corporate-member-list": CorporateMemberList,
    ...
    "corporate-project-create-request": CorporateProjectCreateRequest,
    "corporate-project-list": CorporateProjectList,
    "corporate-project-update-request": CorporateProjectUpdateRequest,
    "corporate-project-view": CorporateProjectView,
    "corporate-role-create-request": CorporateRoleCreateRequest,
    "corporate-role-list": CorporateRoleList,
    "corporate-role-update-request": CorporateRoleUpdateRequest,
    "corporate-role-view": CorporateRoleView,
    "corporate-service-principal-create-request": CorporateServicePrincipalCreateRequest,
    "corporate-service-principal-list": CorporateServicePrincipalList,
    "corporate-service-principal-update-request": CorporateServicePrincipalUpdateRequest,
    "corporate-service-principal-view": CorporateServicePrincipalView,
    "corporate-team-create-request": CorporateTeamCreateRequest,
    "corporate-team-list": CorporateTeamList,
    "corporate-team-update-request": CorporateTeamUpdateRequest,
    "corporate-team-view": CorporateTeamView,
    "project-link-request": ProjectLinkRequest,
    "project-link-proposal-request": ProjectLinkProposalRequest,
    "project-link-plan-request": ProjectLinkPlanRequest,
    "project-link-plan-response": ProjectLinkPlanResponse,
    "project-link-response": ProjectLinkResponse,
    "provider-project-observation-request": ProviderProjectObservationRequest,
    "project-unlink-request": ProjectUnlinkRequest,
    "project-unlink-plan-request": ProjectUnlinkPlanRequest,
    "project-unlink-plan-response": ProjectUnlinkPlanResponse,
    "project-sync-plan-request": ProjectSyncPlanRequest,
    "project-sync-plan-response": ProjectSyncPlanResponse,
    "project-sync-apply-request": ProjectSyncApplyRequest,
    "project-conflict-resolution-request": ProjectConflictResolutionRequest,
    "project-revision-push-request": ProjectRevisionPushRequest,
    "project-revision-push-response": ProjectRevisionPushResponse,
    "project-revision-receipt": ProjectRevisionReceipt,
    "project-revision-view": ProjectRevisionView,
    "project-revision-pull-response": ProjectRevisionPullResponse,

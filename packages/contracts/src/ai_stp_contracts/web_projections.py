...
def render_cli_copy() -> str:
    ...
    lines = [
        ...
        f"export const INSTALL_TASK_START = {_ts_string(cli_copy.INSTALL_TASK_START)} as const;",
        f"export const INSTALL_SETUP_START = {_ts_string(cli_copy.INSTALL_SETUP_START)} as const;",
        f"export const LOGIN = {_ts_string(cli_copy.LOGIN)} as const;",
        f"export const INTENTS_BOOTSTRAP = {_ts_string(cli_copy.INTENTS_BOOTSTRAP)} as const;",
        f"export const INITIALIZE_START = {_ts_string(cli_copy.INITIALIZE_START)} as const;",
        f"export const INITIALIZE_PROMPT = {_ts_string(cli_copy.INITIALIZE_PROMPT)} as const;",
        "",
